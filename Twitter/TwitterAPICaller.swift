...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "adbWg6DX4KlqXavwaURaEmZpK", consumerSecret: "teECrQY6HFhx0ncrLMPP29rlMbLxnEINej0YUmK0Xyl7x52LUe")
    var loginSuccess: (() -> ())?
